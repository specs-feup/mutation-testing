...
public final class FindViewByIdDeletionMutator extends Operators{
    ...
    private static final String DESCRIPTION = "FindViewById Deletion";
    public static final String MUTATOR_TYPE = "FindViewByIdDeletionMutator";
