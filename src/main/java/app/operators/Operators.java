...
public abstract class Operators {
    ...
    public static Operators[] assignedOperators = {new ArithmeticOperatorDeletion(), new FailOnNull(), new RemoveNullCheck(), new NullifyInputVariable(), new ArithmeticOperators(),new BitwiseOperators(),new ConditionalOperators(),new RelationalOperators(), new UnaryOperators()};
    ...
    public static String getMutatorString(DataStore dataStore){
        ...
        for(Operators operators : assignedOperators)
            ...
            else if(operators instanceof ArithmeticOperatorDeletion || operators instanceof FailOnNull || operators instanceof RemoveNullCheck || operators instanceof NullifyInputVariable)
                for (String identifier : operators.getIdentifiers()){
