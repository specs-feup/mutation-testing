...
import org.feup.Mutation_Testing_Backend_Final.Dto.Responses.MapResponse;
import org.feup.Mutation_Testing_Backend_Final.Dto.Responses.SimpleResponse;
...
public class MavenTestsController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Did not find the project",
                    content = @Content) })
    public ResponseEntity<MapResponse> getAll(@RequestBody ProjectPathWrapper projectPathWrapper){
