...
import static app.operators.ArithmeticOperators.DIVIDE;
import static app.operators.ArithmeticOperators.MINUS;
import static app.operators.ArithmeticOperators.MULTIPLY;
import static app.operators.ArithmeticOperators.PLUS;
import static app.operators.ArithmeticOperators.REMAINDER;
...
public final class BitwiseOperators extends Operators {
    ...
    private static final List<String> SIGNED_RIGHT_SHIFT_OP = Arrays.asList(MINUS, MULTIPLY, DIVIDE, REMAINDER, PLUS,
            SIGNED_RIGHT_SHIFT, UNSIGNED_RIGHT_SHIFT);
    private static final List<String> SIGNED_LEFT_SHIFT_OP = Arrays.asList(MINUS, MULTIPLY, DIVIDE, REMAINDER,
            SIGNED_LEFT_SHIFT, PLUS, UNSIGNED_RIGHT_SHIFT);
    private static final List<String> UNSIGNED_RIGHT_SHIFT_OP = Arrays.asList(MINUS, MULTIPLY, DIVIDE, REMAINDER,
            SIGNED_LEFT_SHIFT, SIGNED_RIGHT_SHIFT, PLUS);

    private static final List<List<String>> MUTATORS = Arrays.asList(SIGNED_LEFT_SHIFT_OP, SIGNED_RIGHT_SHIFT_OP,
            UNSIGNED_RIGHT_SHIFT_OP);
    private static final List<String> OPERATORS = Arrays.asList(SIGNED_LEFT_SHIFT, SIGNED_RIGHT_SHIFT,
