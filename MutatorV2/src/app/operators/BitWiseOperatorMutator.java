...
public final class BitWiseOperatorMutator extends Operators {
    ...
    private static final List<String> INCLUSIVE_OP = Arrays.asList(LEFT_HAND_SHIFT, RIGHT_HAND_SHIFT, EXCLUSIVE_OR,
            AND);
    private static final List<String> AND_OP = Arrays.asList(LEFT_HAND_SHIFT, RIGHT_HAND_SHIFT, EXCLUSIVE_OR,
            INCLUSIVE_OR);
    private static final List<String> EXCLUSIVE_OP = Arrays.asList(LEFT_HAND_SHIFT, RIGHT_HAND_SHIFT, INCLUSIVE_OR,
            AND);
    ...
    private static final List<String> OPERATORS = Arrays.asList(INCLUSIVE_OR, EXCLUSIVE_OR, LEFT_HAND_SHIFT,
            RIGHT_HAND_SHIFT, AND);
